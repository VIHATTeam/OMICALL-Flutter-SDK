...
class OmiAction {
 ...
 static ActionModel initCall(String userName, String password, String realm) {
    return ActionModel(actionName: ActionName.INIT_CALL,
        data: {'userName': userName, 'password': password, 'realm': realm});
  }

 static ActionModel updateToken(String deviceId,
      {String? deviceTokenAndroid, String? tokenVoipIos }) {
    return ActionModel(actionName: ActionName.UPDATE_TOKEN,
        data: {
 ...
 static ActionModel startCall(String phoneNumber) {
    return ActionModel(
        actionName: ActionName.START_CALL, data: {'phoneNumber': phoneNumber,});
  }
 ...
 static ActionModel toggleMute(bool isMute) {
    return ActionModel(
        actionName: ActionName.TOGGLE_MUTE, data: {'isMute': isMute});
  }

 static  ActionModel toggleSpeaker(bool useSpeaker) {
    return ActionModel(
        actionName: ActionName.TOGGEL_SPREAK, data: {'useSpeaker': useSpeaker});
  }

 static ActionModel decline() {
    return ActionModel(
        actionName: ActionName.DECLINE, data: {});
  }

 static ActionModel hangUp() {
    return ActionModel(
        actionName: ActionName.HANGUP, data: {});
  }
}